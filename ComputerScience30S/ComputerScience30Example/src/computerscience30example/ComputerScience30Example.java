 ...
 */
public class ComputerScience30Example {
    ...
    private static void learnArrays() {
        ...
        // When declaring an array the two square brackets "[ ]" can be put 
        // to the right of the data type OR (in Java) to the right
        ...
        // and TAB) starts at 0, goes up by 1, is "less than" the ending 
        ...
        output(numbers);        // Send a array to a method as a parameter
        ...
        String first = "C:\\Users\\m.galinsky\\Desktop\\";
